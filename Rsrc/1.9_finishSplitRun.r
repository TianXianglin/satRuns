...
#source("Rsrc/mainSettings.r") ### on CSC
...
#### Finish processing 1.9 with the combined data. This block matches lines: 82 - 105 in 1.9_optST_parallel.
...
save(stProb,probit1,probit2,stProbMod_bind,file="stProbMod_parallel_bind_nSample1000.rdata")
